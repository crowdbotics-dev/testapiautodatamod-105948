...
## Project Structure
    ...
    ├── testapiautodatamod_105948  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_105948`
...
2. Clone this repo and `cd testapiautodatamod_105948`
